...
/**
 * ModÃ©lise un éditeur/créateur de carte basique
...
public interface Card {
  ...
  //  coordonnées de véhicle(d:d;d:d; ou d:d;d:d;d:d où d repr�sente un chiffre)
   ...
   */
  Map<Vehicle,List<Coord>> getPlaces();
   ...
   *    carte != null
   */
  void save(Map<Vehicle,List<Coord>> carte) throws IOException;
