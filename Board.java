...
public interface Board {
  ...
  /**
   * Indique la coordonnée du premier véhicule rencontré à l'arrière
   */
  Coord getFirstVehicleBefore(Vehicle veh);
  
  /**
   * Indique la coordonnée du premier véhicule rencontré à l'avant
   */
   ...
   *      getCoord(vehicle) == c
   */
  void moveTo (Vehicle veh, Coord coord);
