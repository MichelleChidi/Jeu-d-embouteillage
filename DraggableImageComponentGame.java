...
public class DraggableImageComponentGame extends DraggableComponentGame implements ImageObserver {

	protected Image image;
    private boolean autoSize = false;
    private Dimension autoSizeDimension = new Dimension(0, 0);

    public DraggableImageComponentGame(Board m, Vehicle v, Coord c) {
        super(m, v, c);
        setLayout(null);
